...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ConferenceRegistration.billing_address'
        db.add_column(u'conferences_conferenceregistration', 'billing_address', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ConferenceRegistration.billing_address'
        db.delete_column(u'conferences_conferenceregistration', 'billing_address')
