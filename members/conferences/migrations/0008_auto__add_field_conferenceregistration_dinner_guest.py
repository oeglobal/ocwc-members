...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ConferenceRegistration.dinner_guest'
        db.add_column(u'conferences_conferenceregistration', 'dinner_guest', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ConferenceRegistration.dinner_guest'
        db.delete_column(u'conferences_conferenceregistration', 'dinner_guest')
