...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Election.nominate_until'
        db.add_column(u'elections_election', 'nominate_until', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)

        # Adding field 'Election.vote_from'
        db.add_column(u'elections_election', 'vote_from', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)

        # Adding field 'Election.vote_until'
        db.add_column(u'elections_election', 'vote_until', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Election.nominate_until'
        db.delete_column(u'elections_election', 'nominate_until')

        # Deleting field 'Election.vote_from'
        db.delete_column(u'elections_election', 'vote_from')

        # Deleting field 'Election.vote_until'
        db.delete_column(u'elections_election', 'vote_until')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 24, 14, 49, 25, 441696)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 24, 14, 49, 25, 441317)'}),
