...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CandidateBallot.election'
        db.add_column(u'elections_candidateballot', 'election', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['elections.Election']), keep_default=False)

        # Adding field 'PropositionBallot.election'
        db.add_column(u'elections_propositionballot', 'election', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['elections.Election']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CandidateBallot.election'
        db.delete_column(u'elections_candidateballot', 'election_id')

        # Deleting field 'PropositionBallot.election'
        db.delete_column(u'elections_propositionballot', 'election_id')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 13, 6, 5, 30, 591829)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 13, 6, 5, 30, 591108)'}),
