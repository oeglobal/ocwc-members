...
class NominationFormTest(TestCase):
    ...
    def testNomination(self):
        ...
        self.assertIn(
            "You have been nominated to serve on the OCWC Board of Directors",
            email.subject,
        )
        self.assertIn(
            "has nominated you as a candidate for the Board of Directors", email.body
        )
        # assert edit link
    ...
    def testVotingProcedure(self):
        ...
        # log us in
        self.client.post("", {"email": "tech@oeglobal.org", "organization": 1})
