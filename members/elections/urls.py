...
urlpatterns = [
    ...
    url(
        r"^api/candidate/list/(?P<key>[\w|\W]+)/$",
    ...
    url(r"^vote/results/$", VoteResults.as_view(), name="vote-results"),
]
