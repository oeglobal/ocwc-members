...
urlpatterns = [
    ...
    url(r'^invoice/key/(?P<access_key>\w+)/$', InvoicePhantomJSView.as_view(lookup_field='access_key'),
    ...
    url(r'^billinglog/list/(?P<username>\w+)/$', OrganizationBillingLogListingView.as_view(),
    ...
    url(r'^organization/list/excel/$', OrganizationExportExcel.as_view(), name='organization-list-excel'),
    url(r'^organization/list/excel-cccoer/$', OrganizationExportCccoerExcel.as_view(),
        name='organization-list-excel-cccoer'),
    url(r'^organization/list/nocontact/$', OrganizationStaffNoContactListView.as_view(),
