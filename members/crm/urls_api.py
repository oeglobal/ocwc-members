...
urlpatterns = patterns('',
                       ...
                       url(r'^organization/by_country/(?P<country>[\w|\W]+)/list/$',
                           OrganizationByCountryListViewApi.as_view(lookup_field='country'),
                           name='organization-by_country-list'),
                       url(r'^organization/group_by/membership_type/list/$', organization_group_by_membership_view,
                           name='organization-group_by_membership_type-list'),
                       url(r'^organization/group_by/consortium/(?P<consortium>[\w|\W]+)/list/$',
                           organization_group_by_consortium_view, name='organization-group_by_membership_type-list'),
                       url(r'^organization/feeds/$', OrganizationRssFeedsApi.as_view(), name='organization-feeds'),
                       )
