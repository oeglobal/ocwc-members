...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Address.address_type'
        db.add_column(u'crm_address', 'address_type', self.gf('django.db.models.fields.CharField')(default='primary', max_length=25), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Address.address_type'
        db.delete_column(u'crm_address', 'address_type')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 9, 4, 16, 8, 983191)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 9, 4, 16, 8, 982771)'}),
        ...
        u'crm.billinglog': {
            ...
            'invoice_year': ('django.db.models.fields.CharField', [], {'default': "'2015'", 'max_length': '10'}),
