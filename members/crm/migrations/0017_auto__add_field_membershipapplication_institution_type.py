...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MembershipApplication.institution_type'
        db.add_column(u'crm_membershipapplication', 'institution_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MembershipApplication.institution_type'
        db.delete_column(u'crm_membershipapplication', 'institution_type')
