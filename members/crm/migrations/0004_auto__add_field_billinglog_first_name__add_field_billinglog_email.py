...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BillingLog.first_name'
        db.add_column(u'crm_billinglog', 'first_name', self.gf('django.db.models.fields.CharField')(default='', max_length=60, blank=True), keep_default=False)

        # Adding field 'BillingLog.email'
        db.add_column(u'crm_billinglog', 'email', self.gf('django.db.models.fields.CharField')(default='', max_length=120, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BillingLog.first_name'
        db.delete_column(u'crm_billinglog', 'first_name')

        # Deleting field 'BillingLog.email'
        db.delete_column(u'crm_billinglog', 'email')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 16, 5, 53, 36, 239020)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 16, 5, 53, 36, 238628)'}),
