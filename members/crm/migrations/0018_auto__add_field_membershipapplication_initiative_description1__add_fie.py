...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MembershipApplication.initiative_description1'
        db.add_column(u'crm_membershipapplication', 'initiative_description1',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'MembershipApplication.initiative_url1'
        db.add_column(u'crm_membershipapplication', 'initiative_url1',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'MembershipApplication.initiative_description2'
        db.add_column(u'crm_membershipapplication', 'initiative_description2',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'MembershipApplication.initiative_url2'
        db.add_column(u'crm_membershipapplication', 'initiative_url2',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'MembershipApplication.initiative_description3'
        db.add_column(u'crm_membershipapplication', 'initiative_description3',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'MembershipApplication.initiative_url3'
        db.add_column(u'crm_membershipapplication', 'initiative_url3',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MembershipApplication.initiative_description1'
        db.delete_column(u'crm_membershipapplication', 'initiative_description1')

        # Deleting field 'MembershipApplication.initiative_url1'
        db.delete_column(u'crm_membershipapplication', 'initiative_url1')

        # Deleting field 'MembershipApplication.initiative_description2'
        db.delete_column(u'crm_membershipapplication', 'initiative_description2')

        # Deleting field 'MembershipApplication.initiative_url2'
        db.delete_column(u'crm_membershipapplication', 'initiative_url2')

        # Deleting field 'MembershipApplication.initiative_description3'
        db.delete_column(u'crm_membershipapplication', 'initiative_description3')

        # Deleting field 'MembershipApplication.initiative_url3'
        db.delete_column(u'crm_membershipapplication', 'initiative_url3')
