...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BillingLog.email_subject'
        db.add_column(u'crm_billinglog', 'email_subject', self.gf('django.db.models.fields.CharField')(default='', max_length=140, blank=True), keep_default=False)

        # Adding field 'BillingLog.email_body'
        db.add_column(u'crm_billinglog', 'email_body', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BillingLog.email_subject'
        db.delete_column(u'crm_billinglog', 'email_subject')

        # Deleting field 'BillingLog.email_body'
        db.delete_column(u'crm_billinglog', 'email_body')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 29, 10, 23, 11, 336186)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 29, 10, 23, 11, 335814)'}),
        ...
        u'crm.billinglog': {
            ...
            'invoice_year': ('django.db.models.fields.CharField', [], {'default': "'2014'", 'max_length': '10'}),
