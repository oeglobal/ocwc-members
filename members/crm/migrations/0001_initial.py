...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'crm_membershipapplication', (
            ...
            ('access_link_key', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('legacy_application_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('legacy_entity_id', self.gf('django.db.models.fields.IntegerField')()),
            ...
            ('app_status', self.gf('django.db.models.fields.CharField')(max_length=255)),
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 1, 12, 21, 36, 889854, tzinfo=<UTC>)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 1, 12, 21, 36, 889451, tzinfo=<UTC>)'}),
        ...
        u'crm.membershipapplication': {
            ...
            'access_link_key': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            ...
            'app_status': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            ...
            'legacy_entity_id': ('django.db.models.fields.IntegerField', [], {}),
