...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organization.institution_type'
        db.add_column(u'crm_organization', 'institution_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True),
                      keep_default=False)

        # Adding field 'Organization.initiative_description1'
        db.add_column(u'crm_organization', 'initiative_description1',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Organization.initiative_url1'
        db.add_column(u'crm_organization', 'initiative_url1',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Organization.initiative_description2'
        db.add_column(u'crm_organization', 'initiative_description2',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Organization.initiative_url2'
        db.add_column(u'crm_organization', 'initiative_url2',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Organization.initiative_description3'
        db.add_column(u'crm_organization', 'initiative_description3',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Organization.initiative_url3'
        db.add_column(u'crm_organization', 'initiative_url3',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=255, blank=True),
                      keep_default=False)


        # Changing field 'MembershipApplication.logo_large'
        db.alter_column(u'crm_membershipapplication', 'logo_large', self.gf('django.db.models.fields.files.ImageField')(max_length=765))

    def backwards(self, orm):
        # Deleting field 'Organization.institution_type'
        db.delete_column(u'crm_organization', 'institution_type')

        # Deleting field 'Organization.initiative_description1'
        db.delete_column(u'crm_organization', 'initiative_description1')

        # Deleting field 'Organization.initiative_url1'
        db.delete_column(u'crm_organization', 'initiative_url1')

        # Deleting field 'Organization.initiative_description2'
        db.delete_column(u'crm_organization', 'initiative_description2')

        # Deleting field 'Organization.initiative_url2'
        db.delete_column(u'crm_organization', 'initiative_url2')

        # Deleting field 'Organization.initiative_description3'
        db.delete_column(u'crm_organization', 'initiative_description3')

        # Deleting field 'Organization.initiative_url3'
        db.delete_column(u'crm_organization', 'initiative_url3')


        # Changing field 'MembershipApplication.logo_large'
        db.alter_column(u'crm_membershipapplication', 'logo_large', self.gf('django.db.models.fields.CharField')(max_length=765))
    ...
    models = {
        ...
        u'crm.address': {
            ...
            'address_type': ('django.db.models.fields.CharField', [], {'default': "'primary'", 'max_length': '25'}),
        ...
        u'crm.billinglog': {
            ...
            'created_date': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            ...
            'email_subject': ('django.db.models.fields.CharField', [], {'max_length': '140', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoice': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['crm.Invoice']", 'null': 'True', 'blank': 'True'}),
            'invoice_number': ('django.db.models.fields.CharField', [], {'max_length': '60', 'null': 'True', 'blank': 'True'}),
            'invoice_year': ('django.db.models.fields.CharField', [], {'default': "'2017'", 'max_length': '10'}),
            'log_type': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
        ...
        u'crm.contact': {
            ...
            'bouncing': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'crm.country': {
            ...
            'continent': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['crm.Continent']", 'null': 'True', 'blank': 'True'}),
            'developing': ('django.db.models.fields.BooleanField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'crm.invoice': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoice_number': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
            'invoice_type': ('django.db.models.fields.CharField', [], {'default': "'issued'", 'max_length': '30'}),
            'invoice_year': ('django.db.models.fields.CharField', [], {'default': "'2017'", 'max_length': '10'}),
            'organization': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['crm.Organization']"}),
            'paypal_link': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'pdf_filename': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'})
        },
        u'crm.loginkey': {
        ...
        u'crm.membershipapplication': {
            ...
            'first_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'initiative_description1': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'initiative_description2': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'initiative_description3': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'initiative_url1': ('django.db.models.fields.URLField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
            'initiative_url2': ('django.db.models.fields.URLField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
            'initiative_url3': ('django.db.models.fields.URLField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
            'institution_country': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['crm.Country']", 'null': 'True', 'blank': 'True'}),
            'institution_type': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25', 'blank': 'True'}),
            ...
            'logo_large': ('django.db.models.fields.files.ImageField', [], {'max_length': '765', 'blank': 'True'}),
            ...
            'organization_type': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '765', 'blank': 'True'}),
            'postal_code': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
