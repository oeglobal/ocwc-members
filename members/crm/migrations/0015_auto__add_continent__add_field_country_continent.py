...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'crm_continent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=192, blank=True)),
        ))
        db.send_create_signal(u'crm', ['Continent'])

        # Adding field 'Country.continent'
        db.add_column(u'crm_country', 'continent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.Continent'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Continent'
        db.delete_table(u'crm_continent')

        # Deleting field 'Country.continent'
        db.delete_column(u'crm_country', 'continent_id')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 21, 5, 19, 0, 199597)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 21, 5, 19, 0, 199012)'}),
        ...
        u'crm.billinglog': {
            ...
            'invoice_year': ('django.db.models.fields.CharField', [], {'default': "'2016'", 'max_length': '10'}),
