...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ReportedStatistic.last_modified'
        db.alter_column(u'crm_reportedstatistic', 'last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))


    def backwards(self, orm):
        
        # Changing field 'ReportedStatistic.last_modified'
        db.alter_column(u'crm_reportedstatistic', 'last_modified', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 27, 11, 28, 59, 455848)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 27, 11, 28, 59, 455456)'}),
