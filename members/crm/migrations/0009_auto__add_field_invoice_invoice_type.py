...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invoice.invoice_type'
        db.add_column(u'crm_invoice', 'invoice_type', self.gf('django.db.models.fields.CharField')(default='issued', max_length=30), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Invoice.invoice_type'
        db.delete_column(u'crm_invoice', 'invoice_type')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 29, 12, 35, 59, 159777)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 29, 12, 35, 59, 159310)'}),
