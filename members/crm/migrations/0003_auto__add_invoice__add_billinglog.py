...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'crm_invoice', (
            ...
            ('invoice_number', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
            ('invoice_year', self.gf('django.db.models.fields.CharField')(default='2013', max_length=10)),
            ('amount', self.gf('django.db.models.fields.IntegerField')()),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('pdf_filename', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('access_key', self.gf('django.db.models.fields.CharField')(max_length=32, blank=True)),
            ('paypal_link', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'crm', ['Invoice'])

        # Adding model 'BillingLog'
        db.create_table(u'crm_billinglog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('log_type', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('organization', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.Organization'])),
            ('pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('amount', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('invoice', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.Invoice'], null=True)),
            ('invoice_year', self.gf('django.db.models.fields.CharField')(default='2013', max_length=10)),
            ('note', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'crm', ['BillingLog'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'crm_billinglog')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 14, 7, 29, 14, 216952)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 14, 7, 29, 14, 216581)'}),
        ...
        u'crm.billinglog': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoice': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['crm.Invoice']", 'null': 'True'}),
            'invoice_year': ('django.db.models.fields.CharField', [], {'default': "'2013'", 'max_length': '10'}),
        ...
        u'crm.reportedstatistic': {
            ...
            'carry_forward': ('django.db.models.fields.BooleanField', [], {}),
